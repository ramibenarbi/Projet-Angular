...
@Component({
  selector: 'app-historique1',
  templateUrl: './historique1.component.html',
  styleUrls: ['./historique1.component.css']
})
export class Historique1Component implements OnInit {
...
date(e){
  this.auth.getDataaByDay(e).subscribe(x => {
    console.log(x)
