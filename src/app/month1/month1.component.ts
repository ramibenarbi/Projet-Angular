...
@Component({
  ...
  styleUrls: ['./month1.component.css']
})
...
if( this.datas2[9]=== undefined){
 ...
 this.avg=(this.b+this.c+this.d+this.e+this.f+this.g+this.h+this.i+this.j+this.k+this.l+this.m+this.xx+this.n+this.o+this.p+this.aa+this.bb+this.cc+this.dd+this.ee+this.ff+this.gg+this.hh+this.ii+this.jj+this.kk+this.ll+this.mm+this.nn+this.oo)/31
